...
import {
  ...
  getInstrumentosPorNivel,
  getInstrumentoPorId,
  buscarInstrumentos,
  getProgressoInstrumento,
  getInstrumentosDoAluno,
  getInstrumentoPrincipal,
  atualizarProgressoInstrumento,
  getEstatisticasBiblioteca
} from '@/lib/supabase/queries/instrumentos'
...
export function useInstrumentosPorCategoria(categoria: string) {
  return useQuery({
...
export function useInstrumentosPorNivel(nivel: string) {
  return useQuery({
...
export function useInstrumento(id: string) {
  return useQuery({
...
export function useBuscarInstrumentos(termo: string) {
  return useQuery({
...
export function useProgressoInstrumento(alunoId: string, instrumentoId: string) {
  return useQuery({
...
export function useInstrumentosDoAluno(alunoId: string) {
  return useQuery({
...
export function useInstrumentoPrincipal(alunoId: string) {
  return useQuery({
...
export function useAtualizarProgressoInstrumento() {
  ...
  return useMutation({
    ...
    }) => atualizarProgressoInstrumento(alunoId, instrumentoId, dados),
