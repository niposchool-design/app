...
// 🎌 Tipos do sistema de cards japonês
interface CardProps extends React.HTMLAttributes<HTMLDivElement> {
  variant?: 'default' | 'elevated' | 'outlined' | 'glass' | 'zen'
...
export function StudentCard(props: Omit<CardProps, 'role'>) {
  return <Card {...props} role="student" philosophy="kaizen" />
}

export function ProfessorCard(props: Omit<CardProps, 'role'>) {
  return <Card {...props} role="professor" philosophy="zen" />
}

export function AdminCard(props: Omit<CardProps, 'role'>) {
  return <Card {...props} role="admin" philosophy="wabi-sabi" />
}
...
export function ZenCard(props: CardProps) {
  return <Card {...props} variant="zen" philosophy="zen" />
}

export function InteractiveCard(props: CardProps) {
  return <Card {...props} interactive />
}
...
export function CardHeader({ children, className = '', ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return (
    <div 
      className={`px-6 py-4 border-b border-nipo-zen-200 dark:border-nipo-zen-700 ${className}`}
      {...props}
    >
      {children}
    </div>
...
export function CardFooter({ children, className = '', ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return (
    <div 
      className={`px-6 py-4 border-t border-nipo-zen-200 dark:border-nipo-zen-700 ${className}`}
      {...props}
    >
      {children}
    </div>
...
export function CardTitle({ children, className = '', ...props }: React.HTMLAttributes<HTMLHeadingElement>) {
  return (
    <h3 
      className={`text-lg font-zen font-semibold text-nipo-zen-900 dark:text-white ${className}`}
      {...props}
    >
      {children}
    </h3>
...
export function CardDescription({ children, className = '', ...props }: React.HTMLAttributes<HTMLParagraphElement>) {
  return (
    <p 
      className={`text-sm text-nipo-zen-600 dark:text-nipo-zen-400 ${className}`}
      {...props}
    >
      {children}
    </p>
