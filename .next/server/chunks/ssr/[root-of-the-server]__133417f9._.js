module.exports=[93695,(a,b,c)=>{b.exports=a.x("next/dist/shared/lib/no-fallback-error.external.js",()=>require("next/dist/shared/lib/no-fallback-error.external.js"))},70864,a=>{a.n(a.i(33290))},43619,a=>{a.n(a.i(79962))},13718,a=>{a.n(a.i(85523))},18198,a=>{a.n(a.i(45518))},62212,a=>{a.n(a.i(66114))},68815,a=>{a.n(a.i(60204))},60573,a=>{"use strict";var b=a.i(98310);async function c(a){let c=await (0,b.createClient)(),{data:d,error:e}=await c.from("aulas").select(`
    ...
    `).eq("turma_id",a).order("aluno(full_name)");return e?(console.error("Erro ao buscar alunos da turma:",e),[]):d}a.s(["getAlunosTurma",()=>h,"getCurrentProfile",()=>c,"getMatriculasAluno",()=>e,"getProfileById",()=>d,"getTurmaById",()=>g,"getTurmas",()=>f])},84996,a=>{"use strict";let b=(0,a.i(11857).registerClientReference)(function(){throw Error("Attempted to call the default export of [project]/app/(protected)/alunos/progresso/_components/ProgressoClient.tsx <module evaluation> from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.")},"[project]/app/(protected)/alunos/progresso/_components/ProgressoClient.tsx <module evaluation>","default");a.s(["default",0,b])},62694,a=>{"use strict";let b=(0,a.i(11857).registerClientReference)(function(){throw Error("Attempted to call the default export of [project]/app/(protected)/alunos/progresso/_components/ProgressoClient.tsx from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.")},"[project]/app/(protected)/alunos/progresso/_components/ProgressoClient.tsx","default");a.s(["default",0,b])},48243,a=>{"use strict";a.i(84996);var b=a.i(62694);a.n(b)},60912,a=>{"use strict";var b=a.i(7997),c=a.i(60573),d=a.i(27230),e=a.i(48243);async function f(){let a=await (0,d.getCurrentProfile)(),f=await (0,c.getProgressoGeralAluno)(a.id),g=await (0,c.getEstatisticasProgresso)(a.id),h={licoesCompletadas:Array.isArray(f)?f.filter(a=>"concluida"===a.status).length:0,horasPraticadas:Math.round((Array.isArray(f)?f.reduce((a,b)=>a+(b.tempo_pratica||0),0):0)/60),conquistasTotal:0,nivelAtual:a.nivel||1,pontosXP:a.xp||0,sequenciaAtual:g?.dias_consecutivos||0};return(0,b.jsx)(e.default,{stats:h,instrumentosJaponeses:[{nome:"Koto",progresso:65,nivel:"Intermediário",cor:"red",horas:12},{nome:"Shamisen",progresso:40,nivel:"Básico",cor:"orange",horas:8},{nome:"Shakuhachi",progresso:25,nivel:"Iniciante",cor:"yellow",horas:5}],metasSemanais:[{titulo:"Completar 10 lições",atual:7,total:10,cor:"bg-red-500",icone:"BookOpen"},{titulo:"Praticar 5 horas",atual:3.5,total:5,cor:"bg-orange-500",icone:"Clock"},{titulo:"Obter 3 conquistas",atual:2,total:3,cor:"bg-yellow-500",icone:"Trophy"}],conquistasRecentes:[{nome:"Primeira Aula Koto",data:"2025-01-15",pontos:50,icone:"🎵",cor:"red"},{nome:"Prática Diária",data:"2025-01-20",pontos:100,icone:"🔥",cor:"orange"},{nome:"Mestre da Teoria",data:"2025-02-01",pontos:150,icone:"🎼",cor:"yellow"},{nome:"Sequência de 5 Dias",data:"2025-02-10",pontos:200,icone:"⭐",cor:"pink"}]})}a.s(["default",()=>f])}];

//# sourceMappingURL=%5Broot-of-the-server%5D__133417f9._.js.map