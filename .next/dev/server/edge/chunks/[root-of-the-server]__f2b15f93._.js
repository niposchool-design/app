...
async function middleware(request) {
    ...
    if (session) {
        ...
        // @ts-ignore
        const { data: userRole } = await supabase.from('user_roles').select('role_type, is_active').eq('user_id', session.user.id).eq('is_active', true).single();
        ...
        if (path === '/login' || path === '/') {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$exports$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL(userArea, request.url));
        }
        ...
        if (path === '/professores/dashboard') {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$exports$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL('/professores', request.url));
        }
        if (path === '/alunos/dashboard') {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$exports$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL('/alunos', request.url));
        }
