...
"[project]/app/(protected)/admin/diagnostico/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SystemDiagnosticPage() {
    _s();
    const { user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$providers$2f$AuthProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const systemComponents = [
        // Dashboards
        {
            ...
            path: '/admin',
            status: 'loading',
            description: 'Dashboard administrativo principal',
            role: 'admin'
        },
        {
            ...
            path: '/professores',
            status: 'loading',
            description: 'Dashboard para professores',
            role: 'professor'
        },
        {
            ...
            path: '/alunos',
            status: 'loading',
            description: 'Dashboard para alunos',
            role: 'aluno'
        },
        // Páginas Admin
        {
        ...
        },
        {
            ...
            status: 'loading',
            description: 'Gestão de gamificação',
            role: 'admin'
        },
        {
            name: 'QR Codes',
            path: '/admin/qr/gerenciar',
            status: 'loading',
            description: 'Gerenciador de QR Codes',
            role: 'admin'
        },
        // Páginas Principais
        {
            ...
            status: 'loading',
            description: 'Gestão de instrumentos',
            role: 'admin'
        },
        {
            name: 'Repertório',
            path: '/admin/repertorio',
            status: 'loading',
            description: 'Gestão de repertório',
            role: 'admin'
        },
    ...
    const checkComponents = async ()=>{
        ...
        for (const component of systemComponents){
            ...
            // Como estamos na área admin, assumimos que o usuário logado é admin ou tem permissão
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SystemDiagnosticPage.useEffect": ()=>{
            checkComponents();
        }
    }["SystemDiagnosticPage.useEffect"], [
        user
        ...
        switch(status){
            case 'ok':
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$circle$2d$check$2d$big$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__CheckCircle$3e$__["CheckCircle"], {
                    ...
                    fileName: "[project]/app/(protected)/admin/diagnostico/page.tsx",
                    lineNumber: 90,
                    columnNumber: 24
                }, this);
            case 'error':
    ...
    const filterComponentsByRole = (components)=>{
        ...
        return components.filter((component)=>component.role === 'all' || component.role === user.role || user.role === 'admin' // Admin vê tudo
        );
    };
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: "Verificação completa de componentes e rotas do Nipo School"
                    }, void 0, false, {
                        fileName: "[project]/app/(protected)/admin/diagnostico/page.tsx",
                        lineNumber: 135,
                        columnNumber: 17
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: visibleComponents.length
                                        }, void 0, false, {
                                            fileName: "[project]/app/(protected)/admin/diagnostico/page.tsx",
                                            lineNumber: 176,
                                            columnNumber: 29
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                    ...
                                    children: "Status dos Componentes"
                                }, void 0, false, {
                                    fileName: "[project]/app/(protected)/admin/diagnostico/page.tsx",
                                    lineNumber: 187,
                                    columnNumber: 25
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "space-y-3",
                            children: visibleComponents.map((component, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    className: `px-2 py-1 rounded-full text-xs font-medium ${component.status === 'ok' ? 'bg-green-100 text-green-800' : component.status === 'error' ? 'bg-red-100 text-red-800' : component.status === 'warning' ? 'bg-yellow-100 text-yellow-800' : 'bg-blue-100 text-blue-800'}`,
                                                    children: getStatusText(component.status)
                                                }, void 0, false, {
                                                    fileName: "[project]/app/(protected)/admin/diagnostico/page.tsx",
                                                    lineNumber: 216,
                                                    columnNumber: 37
                                                }, this),
                                                component.status === 'ok' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                                    href: component.path,
...
_s(SystemDiagnosticPage, "mLKdcg4UZVnj5pr8Ket5t93DiH4=", false, function() {
    return [
...
_c = SystemDiagnosticPage;
var _c;
__turbopack_context__.k.register(_c, "SystemDiagnosticPage");
...
//# sourceMappingURL=_b0a24701._.js.map