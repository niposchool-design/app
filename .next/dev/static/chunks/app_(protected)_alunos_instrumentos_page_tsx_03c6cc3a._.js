...
function InstrumentosPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "InstrumentosPage.useEffect": ()=>{
            fetch('/api/instrumentos').then({
                "InstrumentosPage.useEffect": (res)=>res.json()
            }["InstrumentosPage.useEffect"]).then({
                "InstrumentosPage.useEffect": (data)=>{
                    setInstrumentos(data || []);
                    setLoading(false);
                }
            }["InstrumentosPage.useEffect"]).catch({
                "InstrumentosPage.useEffect": ()=>setLoading(false)
            }["InstrumentosPage.useEffect"]);
        }
    }["InstrumentosPage.useEffect"], []);
...
//# sourceMappingURL=app_%28protected%29_alunos_instrumentos_page_tsx_03c6cc3a._.js.map