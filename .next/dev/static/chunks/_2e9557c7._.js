...
async function getAdminDashboardStats() {
    try {
        // Total de alunos ativos (via profiles.tipo_usuario)
        const { count: totalAlunos } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('*', {
            count: 'exact',
            head: true
        }).eq('tipo_usuario', 'aluno').eq('ativo', true);
        // Total de professores ativos (via profiles.tipo_usuario)
        const { count: totalProfessores } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('*', {
            count: 'exact',
            head: true
        }).eq('tipo_usuario', 'professor').eq('ativo', true);
        // Total de aulas ativas (excluindo canceladas)
        const { count: totalAulas } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('aulas').select('*', {
            count: 'exact',
            head: true
        }).eq('ativo', true).neq('status', 'cancelada');
        // Aulas hoje
        const hoje = new Date().toISOString().split('T')[0];
        const { count: aulasHoje } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('aulas').select('*', {
            count: 'exact',
            head: true
        }).eq('ativo', true).gte('data', `${hoje}T00:00:00`).lt('data', `${hoje}T23:59:59`);
        return {
...
async function getProfessores(filters) {
    try {
        let query = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('*', {
            count: 'exact'
...
async function getProfessorById(userId) {
    try {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('*').eq('id', userId).eq('tipo_usuario', 'professor').single();
        if (error) throw error;
        return data;
    } catch (error) {
...
async function getAlunoById(userId) {
    try {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('*').eq('id', userId).eq('tipo_usuario', 'aluno').single();
        if (error) throw error;
        return data;
    } catch (error) {
...
async function getAulasAgendadas(limit = 10) {
    try {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('aulas').select(`
        id,
        titulo,
        descricao,
        data,
...
_s(AdminDashboard, "ey7WhqmRAbbJZ0vbiXHd9uQlzrA=");
_c = AdminDashboard;
var _c;
...
//# sourceMappingURL=_2e9557c7._.js.map