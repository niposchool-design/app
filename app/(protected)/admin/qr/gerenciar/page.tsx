...
// Modal Component
function CreateQRModal({ onClose, onCreate }: { onClose: () => void, onCreate: (tipo: string, referenciaId: string) => void }) {
                        ...
                        >
                            <div className="flex flex-col md:flex-row items-start justify-between gap-4">
                                <div className="flex-1">
                                    ...
                                    <div className="flex flex-wrap items-center gap-4 md:gap-6 text-sm text-gray-600 mt-3">
                                        ...
                                        <div>
                                            <span className={`px-3 py-1 rounded-full text-xs font-semibold ${qr.ativo
                                ...
                                <div className="flex items-center gap-2 self-end md:self-center">
                                    ...
                                    <button
                                        ...
                                        className={`p-2 rounded-lg transition-colors ${qr.ativo
