 ...
 */
export async function checkTablesExist(): Promise<SqlExecutionResult> {
  const tablesToCheck = [
    'profiles',
 ...
 */
export async function checkDataExists(): Promise<SqlExecutionResult> {
  const tablesToCheck = [
    'categorias_instrumentos',
 ...
 */
export async function createBasicCategories(): Promise<SqlExecutionResult> {
 ...
 */
export async function createBasicInstruments(): Promise<SqlExecutionResult> {
  const startTime = Date.now()
  ...
  try {
    ...
    const instrumentos = [
      ...
      },
      {
        ...
        nivel_dificuldade: 'iniciante' as const
      },
      {
        nome: 'Taiko',
        categoria: catMap['Tradicionais'] || 'Tradicionais',
 ...
 */
export async function setupBasicDatabase(): Promise<SqlExecutionResult[]> {
 ...
 */
export async function clearTestData(): Promise<SqlExecutionResult> {
  try {
