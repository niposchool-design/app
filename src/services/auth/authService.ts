...
export class AuthService {
   ...
   */
  async signUp(email: string, password: string, fullName: string, userType: 'aluno' | 'professor' | 'pastor' | 'admin') {
    try {
   ...
   * Criar perfil inicial
   */
  private async createInitialProfile(userId: string, profileData: Omit<ProfileInsert, 'id'>) {
    try {
   ...
   */
  async logUserActivity(userId: string, activity: string, metadata?: any) {
    try {
