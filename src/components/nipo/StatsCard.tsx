        ...
        <div className="flex items-start justify-between mb-4">
          ...
          {trend && TrendIcon && (
            ...
            `}>
              ...
              {trendValue && (
                <span className="text-xs font-zen font-medium">
                  {trendValue}
                </span>
              )}
            </div>
...
export function StudentStatsCard(props: Omit<StatsCardProps, 'role'>) {
  return <StatsCard {...props} role="student" philosophy="kaizen" />
}

export function ProfessorStatsCard(props: Omit<StatsCardProps, 'role'>) {
  return <StatsCard {...props} role="professor" philosophy="zen" />
}

export function AdminStatsCard(props: Omit<StatsCardProps, 'role'>) {
  return <StatsCard {...props} role="admin" philosophy="wabi-sabi" />
}

// 🎯 Variants específicos
export function GradientStatsCard(props: StatsCardProps) {
  return <StatsCard {...props} variant="gradient" />
}

export function MinimalStatsCard(props: StatsCardProps) {
  return <StatsCard {...props} variant="minimal" />
}

export function DetailedStatsCard(props: StatsCardProps) {
  return <StatsCard {...props} variant="detailed" />
}
