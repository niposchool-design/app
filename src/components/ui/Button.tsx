...
// 🎌 Tipos do sistema de botões japonês
...
export function StudentButton(props: Omit<ButtonProps, 'role'>) {
  return <Button {...props} role="student" philosophy="kaizen" />
}

export function ProfessorButton(props: Omit<ButtonProps, 'role'>) {
  return <Button {...props} role="professor" philosophy="zen" />
}

export function AdminButton(props: Omit<ButtonProps, 'role'>) {
  return <Button {...props} role="admin" philosophy="wabi-sabi" />
}
...
export function ZenButton(props: ButtonProps) {
  return <Button {...props} variant="zen" philosophy="zen" />
}