        ...
        <NipoCard className="p-8">
          <div className="text-center mb-8">
            ...
            {isDesbloqueada && userConquista && (
              <div className="flex items-center justify-center text-green-600 font-medium">
                ...
                Desbloqueada em {new Date(userConquista.unlocked_at).toLocaleDateString('pt-BR')}
              </div>
            )}
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="text-center p-4 bg-yellow-50 rounded-lg">
              ...
              <p className="text-2xl font-bold text-yellow-600">{conquista.pontos}</p>
            </div>
          ...
          {!isDesbloqueada && (
            <div className="bg-gray-50 rounded-lg p-6">
              ...
              <p className="text-gray-700">
                {conquista.criterios || 'Complete os requisitos necessários para desbloquear esta conquista.'}
              </p>
            </div>
          )}
        </NipoCard>
